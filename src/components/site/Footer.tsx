  ...
  return (
    <footer style={{ background: "var(--ink)", color: "#fff" }} className="on-dark">
      <div className="container-x py-14 grid md:grid-cols-2 gap-10">
        ...
        <div className="space-y-5 md:text-right">
          <div className="flex flex-wrap gap-x-5 gap-y-2 md:justify-end" style={{ fontSize: 13 }}>
            {navLinks.map((l) => (
              <a key={l.label} href={l.href} className="ulink" style={{ color: "rgba(255,255,255,0.85)" }}>
                {l.label}
              </a>
            ))}
          </div>
          ...
          <div className="flex items-center gap-4 md:justify-end">
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.261 5.635 5.903-5.635zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              Twitter/X
            </a>
            ...
            <a href="#" className="flex items-center gap-1.5 ulink" style={{ color: "rgba(255,255,255,0.75)", fontSize: 13 }}>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        <div className="container-x py-6 flex flex-col md:flex-row justify-between items-center gap-4" style={{ fontSize: 12, color: "rgba(255,255,255,0.6)" }}>
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
            <span>© 2026 Dopamint. All rights reserved.</span>
            <span className="hidden md:inline text-white/20">|</span>
            <span>Powered by <span style={{ color: "var(--primary)", fontWeight: 700 }}>$DOPE</span>.</span>
          </div>
          <div className="flex gap-6" style={{ fontSize: 11 }}>
            <a href="#" className="ulink" style={{ color: "rgba(255,255,255,0.5)" }}>Privacy</a>
            <a href="#" className="ulink" style={{ color: "rgba(255,255,255,0.5)" }}>Terms</a>
          </div>
        </div>
      </div>
    </footer>
